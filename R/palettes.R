...
#' and Ito, http://jfly.iam.u-tokyo.ac.jp/color/. The variant `palette_OkabeIto`
#' contains a gray color, while `palette_OkabeIto_black` contains black instead.
#' @export
palette_OkabeIto <- c(
...
#' @export
palette_atlas <- c(
  "#9BD3DD", "#F2A900", "#8FD6BD", "#F0EC74", "#165C7D",
  "#999999"
)

#' @rdname palette_atlas
#' @export
palette_atlas_black <- c(
  "#9BD3DD", "#F2A900", "#8FD6BD", "#F0EC74", "#165C7D",
  "#000000"
)
