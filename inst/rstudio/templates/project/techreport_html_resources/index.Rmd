...
copyright: "Copyright \\copyright\\ 2026 Accessible Teaching, Learning, and Assessment Systems (ATLAS)"
---
...
set_theme(theme_atlas(plot.margin = margin(3, 10, 0, 10)))

require_font("Roboto Condensed")
```

`r if (knitr::is_html_output()) "# Placeholder Title {.unlisted .unnumbered .blank}"`

`r if (knitr::is_html_output()) "Copyright &copy; 2026 Accessible Teaching, Learning, and Assessment Systems (ATLAS)"`
