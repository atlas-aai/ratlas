...
test_that("we can do something", {
  ...
  invisible(theme_atlas(grid = FALSE))
  invisible(theme_atlas(grid = "XY"))
  invisible(theme_atlas(grid = "xy"))

  invisible(theme_atlas(axis = TRUE))

  invisible(theme_atlas(axis = FALSE))
  invisible(theme_atlas(axis = "xy"))
  invisible(theme_atlas(axis = ""))
