...
```{r menu-sc, echo = FALSE}
    knitr::include_graphics("images/menu_sc.png")
```

```{r new-dir-sc, echo = FALSE}
    knitr::include_graphics("images/new_dir_sc.png")
```

```{r new-proj-sc, echo = FALSE}
    knitr::include_graphics("images/new_project_sc.png")
```
...
Before altering the template file, the template R markdown file should be knitted to ensure that the system is working correctly. The R Markdown file can be knitted by clicking the "Knit" button (displayed below).

```{r knit-sc, echo = FALSE}
    knitr::include_graphics("images/knit_sc.png")
```

## Altering the Setup Chunk

The Setup Chunk (displayed below) is where the default settings for your report are set. 

```{r setup-chunk-sc, echo = FALSE}
    knitr::include_graphics("images/setup_chunk_sc.png")
```

The Setup Chunk will be automatically created for you. The only editing of the Setup Chunk will be 
