...
<center> ![]("images/menu_sc.png") </center>
<center> ![]("images/new_dir_sc.png") </center>
<center> ![](images/new_project_sc.png) </center>
...
A more in-depth introduction to ggplot can be found in the plotting vignette, 
which can be called by typing `vignette(reporting-writing-vignette)`.
