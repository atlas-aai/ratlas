...
When beginning a new report, the first step is to create a new project in RStudio. This can be done by clicking: *File > New Project > New Directory > New Project*, as shown in Figure \@ref(fig:new-proj).

```{r new-proj, echo = FALSE, fig.show = "hold", out.width = "31%", fig.cap = "Creating a new report project."}
knitr::include_graphics(c("images/new-project.png",
                          "images/new-directory.png",
                          "images/selection.png"))
```

From there, specify the project name and the directory where you would like to save the project for the new report. To lessen confusion later, it is usually worthwhile to save each report in its own directory/project so that you can quickly and easily find the report at a later date.
