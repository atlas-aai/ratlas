...
The theme for the plots can also be set globally using the `set_theme()` command, which can be added in the setup code chunk. The `set_theme()` function takes one argument, theme. By default, the theme argument is set to be "theme_atlas", although this can be specified to be "theme_atlas_ms".
