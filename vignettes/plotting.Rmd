...
* For more details on how to customize {ggplot2} graphcis to fit your specific use case, see [*Data Visualization: A Practical Introduction*](https://socviz.co/), by Kieran Healy
* Finally, for a discussion of best principles for data visualization, see [*Fundamentals of Data Visualization*](https://serialmentor.com/dataviz/), by Claus Wilke
